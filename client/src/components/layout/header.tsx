...
// Use the public logo with BASE so it works on GitHub Pages
const BASE = import.meta.env.BASE_URL; // e.g. "/Khaista-Boutique/"
const logo = BASE + "assets/Khaista_Boutique_Logo_1754949895064.jpg";
...
export default function Header() {
  ...
  // Show minimal header after scrolling down a bit
  useEffect(() => {
  ...
  const leftNavigation = [{ name: "What's New", href: "/whats-new" }];
  ...
  return (
    <>
      ...
      <header
        className={`bg-khaista-white shadow-sm sticky top-0 z-50 border-b border-khaista-soft-pink transition-transform duration-300 ${
                ...
                <SheetContent side="right" className="w-[300px] sm:w-[400px]">
                  <nav className="flex flex-col space-y-4 mt-6">
                    ...
                    <div className="space-y-2">
                      <div className="text-lg font-serif font-medium text-khaista-charcoal">
                        Shop
                      </div>
                      {shopCategories.map((cat) => (
                        <Link
      ...
      {/* Minimal Scrolled Header (slides down when scrolled) */}
      <header
        className={`bg-white/95 backdrop-blur-sm shadow-md fixed top-0 w-full z-50 border-b border-khaista-soft-pink transition-transform duration-300 ${
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
              ...
              <SheetContent side="left" className="w-[300px] sm:w-[400px]">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-xl font-serif font-bold text-khaista-charcoal">
                    Menu
                  </h2>
                ...
                <nav className="flex flex-col space-y-4">
                  ...
                  <div className="border-t border-gray-200 pt-4">
                    <h3 className="text-lg font-serif font-semibold text-khaista-charcoal mb-3">
                      Shop
                    </h3>
                    {shopCategories.map((cat) => (
                      <Link
            ...
            {/* Desktop trigger (optional; keeps parity) */}
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
              <SheetTrigger asChild>
            ...
            <div className="absolute left-1/2 transform -translate-x-1/2">
              <Link href="/">
                <span className="text-xl md:text-2xl font-serif font-bold text-khaista-pink tracking-wide hover:text-khaista-pink/80 transition-colors cursor-pointer">
                  Khaista Boutique
                </span>
              </Link>
            </div>
