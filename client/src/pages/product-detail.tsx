...
import { ArrowLeft, ShoppingBag, Star, Truck, Shield, RotateCcw, Ruler, RefreshCcw } from "lucide-react";
      ...
      return (
        <div className="space-y-3">
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div><strong>Necklaces:</strong></div>
            <div>Adjustable length 16-20 inches</div>
            <div><strong>Bracelets:</strong></div>
            <div>Adjustable 6.5-8.5 inches</div>
            <div><strong>Earrings:</strong></div>
            <div>Drop length varies by design</div>
          </div>
          <p className="text-xs text-gray-600 mt-2">
            Most jewelry pieces are adjustable. Contact us for custom sizing.
          </p>
        </div>
      );
    case 'clothing':
      return (
        <div className="space-y-3">
          ...
          <p className="text-xs text-gray-600 mt-2">
            Traditional Afghan dresses are designed to fit loosely. Custom sizing available through Khaista Tailors.
          </p>
        </div>
      );
    case 'bags':
      return (
        <div className="space-y-3">
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div><strong>Small bags:</strong></div>
            <div>8" x 6" x 3"</div>
            <div><strong>Medium bags:</strong></div>
            <div>12" x 9" x 4"</div>
            <div><strong>Large bags:</strong></div>
            <div>16" x 12" x 5"</div>
            <div><strong>Tote bags:</strong></div>
            <div>18" x 14" x 6"</div>
          </div>
          <p className="text-xs text-gray-600 mt-2">
            Measurements are approximate. Each handmade piece may vary slightly.
          </p>
        </div>
      );
    default:
      return (
        <p className="text-sm text-gray-600">
          Size information varies by product. Contact us for specific measurements.
        </p>
      );
  }
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="max-w-4xl mx-auto space-y-6">
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-serif font-bold text-khaista-charcoal mb-4">
                {product.name}
              </h1>
              <div className="flex items-center gap-4 mb-4">
                <span className="text-3xl font-bold text-khaista-turquoise">
                  ${product.price}
                </span>
                <div className="flex items-center gap-1">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} className="h-4 w-4 fill-khaista-amber text-khaista-amber" />
                  ))}
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                <Button
                  className="flex-1 bg-khaista-pink hover:bg-khaista-pink/90 font-serif"
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg font-serif">Product Details</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  <h4 className="font-medium text-gray-900">Materials</h4>
                  <p className="text-gray-600">
                    {product.materials || getSuggestedMaterials(product.category)}
                  </p>
                </div>
                {product.dimensions && (
                  <div>
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    {product.careInstructions || getCareInstructions(product.category)}
                  </p>
                </div>
                <div>
                  <h4 className="font-medium text-gray-900">Origin</h4>
                  <p className="text-gray-600">Handcrafted in Afghanistan by skilled female artisans</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-khaista-soft-pink bg-khaista-cream/50">
              ...
              <CardContent className="space-y-3">
                ...
                <div className="text-xs text-gray-600">
                  ...
                  <p>• Contact us within 30 days to arrange exchanges or alterations</p>
                </div>
              </CardContent>
            </Card>
            ...
            {product.artisanStory && (
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg font-serif">Artisan Story</CardTitle>
                </CardHeader>
                <CardContent>
